        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div
                ...
                <div class="intro-x mt-8">
                    <input type="text"  id="email" name="email" value="{{ old('email') }}" required autocomplete="email" class="intro-x login__input input input--lg border border-gray-300 block"
                           placeholder="Email" autofocus>
                    <input id="password" type="password" class="intro-x login__input input input--lg border border-gray-300 block mt-4" name="password" required autocomplete="current-password">
{{--                    <input type="password"--}}
...
{{--                           placeholder="Password">--}}
                ...
                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                    ...
                    <button class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 mt-3 xl:mt-0">
                        Sign up
                    </button>
                </div>

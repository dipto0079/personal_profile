...
<head>
    ...
    <title>Sudipto | Web Developer</title>
...
<section class="section h-100vh jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('{{asset('frontend/images/home-bg.jpg')}}');" id="home">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="text-white text-center">
                            <h4>Hello & Welcome</h4>
                            <h1 class="header_title mb-0 mt-3">I Am <span class="element font-weight-bold" data-elements="Sudipto Biswas..,A Designer..,A Devloper.."></span></h1>
                            <ul class="social_home list-unstyled text-center pt-4">
                                <li class="list-inline-item"><a href="https://www.facebook.com/developer.sudipto"><i class="mdi mdi-facebook"></i></a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="text-center mx-auto section-main-title">
                    ...
                    <p class="text-muted mx-auto mt-2">Hello! I`m a professional Web Application Developer. I`m here to do my best & make You happy with my skills. As well as I have strong skills in developing professional custom websites.</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="text-center about-detail mx-auto mt-5">
                    ...
                    <ul class="mb-0 list-inline text-center about-work">
                        ...
                        <li class="list-inline-item mr-0 text-muted">Designer</li>
                    </ul>
                    <p class="text-muted mt-3">Results-oriented, meticulous and innovative Web Developer with 6 Month experience building various types of websites using HTML, CSS, JavaScript, jQuery,PHP and Laravel.</p>
                </div>
            </div>
        </div>
        <div class="row mt-5">
            ...
            <div class="col-lg-6">
                <div class="progress-bars skill-custom">
                    ...
                    <div class="clearfix">
                        <div class="text-dark font-weight-bold float-left">JQuery</div>
            ...
            <div class="col-lg-5 offset-lg-2">
                <div class="cv_edu_exp mt-3">
                    <div class="cv_edu_exp_box mt-4">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="cv_edu_exp_year font-weight-bold text-custom position-relative">02/2021 -  06/2021</div>
                                <div class="cb_edu_exp_detail">
                                    <h4>Junior Web Application Developer</h4>
                                    <p class="cv_desc mb-0"><a href="https://www.facebook.com/apitsoft" target="_blank">APitSoft</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center text-white">
                    ...
                    <div class="mt-4">
                        <a href="https://www.freelancer.com/u/sudiptobiswascod" target="_blank" class="btn btn-outline-custom">Hire Me!</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="float-right float_none mt-2 mb-2">
                    <ul class="list-inline fot_social mb-0">
                        <li class="list-inline-item"><a href="https://www.facebook.com/developer.sudipto" class="social-icon text-muted"><i class="mdi mdi-facebook"></i></a></li>
                        <li class="list-inline-item"><a href="https://twitter.com/Sudipto_biswas0" class="social-icon text-muted"><i class="mdi mdi-twitter"></i></a></li>
                        <li class="list-inline-item"><a href="https://www.linkedin.com/in/sudipto-biswas-124410121" class="social-icon text-muted"><i class="mdi mdi-linkedin"></i></a></li>
                        <li class="list-inline-item"><a href="https://gitlab.com/sudipto0097" class="social-icon text-muted"><i class="mdi mdi-github-box"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<!-- Mirrored from themesboss.com/elvish/index_13.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:02:00 GMT -->
</html>
